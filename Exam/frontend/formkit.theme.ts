...
/**
  ...
  *
  * @checksum - 064d399cfd92998573b309aa543cca06546a3db4bc8f714c8b1232957c6f4721
  * @variables - radius=rounded,accentColor=indigo,colorTemperature=neutral,spacing=2,scale=base,inputShadow=shadow,baseColorShade=600,borderShadeLightMode=700,borderShadeDarkMode=800,inputMaxWidth=max-w-[20em],tagRadius=rounded,swatchRadius=rounded
  * @theme - regenesis
  **/
...
const classes: Record<string, Record<string, boolean>> = {
  ...
  "family:dropdown__listbox": {
    ...
    "group-data-[overscroll]:border-neutral-600": true,
  ...
  "color__inner": {
    ...
    "group-data-[prefix-icon]:border-neutral-700": true,
    "group-data-[suffix-icon]:border": true,
    "group-data-[suffix-icon]:border-neutral-700": true,
    "dark:group-data-[prefix-icon]:border-neutral-800": true,
    "dark:group-data-[suffix-icon]:border-neutral-800": true
  },
  "color__input": {
    "appearance-none": true,
    "[color-scheme:light]": true,
  ...
  "submit__input": {
    ...
    "disabled:border-neutral-700": true,
  ...
  "autocomplete__selectionWrapper": {
    ...
    "group-data-[multiple]:border-neutral-600": true,
  ...
  "slider__minValue": {
    ...
    "[&>div>div::after]:bg-neutral-700": true,
    "dark:[&>div>div::after]:bg-neutral-800": true
  },
  "slider__maxValue": {
    "grow": true,
    "!max-w-[45%]": true,
  ...
  "transferlist__transferlistListItem": {
    ...
    "data-[is-active=true]:ring-indigo-500": true,
    "aria-selected:ring-indigo-500": true,
    "relative": true,
    "flex": true,
    "cursor-pointer": true,
    "items-center": true,
  ...
  "multi-step__tabs": {
    ...
    "group-data-[tab-style=\"tab\"]/wrapper:border-neutral-600": true,
